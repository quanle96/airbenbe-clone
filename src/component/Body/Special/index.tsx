...
class Special extends React.Component<Props, State> {
      ...
      <div className='special-wraper'>
        ...
        <div className='special-galary'>
          <Row className='grid-wraper'>
            <Col xs='6'>
              <Cell data={this.state.cards[0]} />
            </Col>
            <Col xs='6'>
              <Row>
                <Col xs='6'>
                  <Cell data={this.state.cards[1]} />
                </Col>
                <Col xs='6'>
                  <Cell data={this.state.cards[2]} />
                </Col>
              </Row>
              <Row>
                <Col xs='12'>
                  <Cell data={this.state.cards[3]} />
                </Col>
              </Row>
            </Col>
          </Row>
